...
import com.musicdrop.tv.MainActivity
...
class FileDropMediaService : MediaSessionService() {
    ...
    override fun onCreate() {
        ...
        kotlinx.coroutines.CoroutineScope(kotlinx.coroutines.Dispatchers.IO).launch {
            com.musicdrop.tv.data.cache.AudioCacheManager.pruneOldAudioCache(applicationContext)
        }
        ...
        setMediaNotificationProvider(
            DefaultMediaNotificationProvider.Builder(this)
                ...
                .setChannelName(com.musicdrop.tv.R.string.app_name)
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        if (intent?.action == "com.musicdrop.tv.ACTION_PLAY_URI" || intent?.action == "com.filedrop.app.ACTION_PLAY_URI") {
