...
object YouTubeSearchRepository {
    ...
    data class DetailedSearchResult(
        ...
        val topArtist: com.musicdrop.app.data.repository.YtMusicApiRepository.YtChartArtist?,
        val albums: List<com.musicdrop.app.data.repository.YtMusicApiRepository.YtCardItem>
    )
    ...
    suspend fun searchDetailed(query: String): DetailedSearchResult = withContext(Dispatchers.IO) {
        ...
        val ytMusicData = try {
            com.musicdrop.app.data.repository.YtMusicApiRepository.search(query)
        } catch (_: Exception) {
            com.musicdrop.app.data.repository.YtMusicApiRepository.YtSearchResultData(emptyList(), null, emptyList())
        }
