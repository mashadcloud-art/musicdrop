 ...
 *
 * Unlike received files — which [com.musicdrop.app.data.repository.MediaStoreRepository]
 ...
 * after the receiver acknowledges it (see [com.musicdrop.app.data.p2p.P2PTransferEngine]'s
